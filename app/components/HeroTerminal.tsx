...
const LINES = [
    ...
    { text: "  ✓ pass-through layout  [chrome deferred]", delay: 3000, color: "text-primary" },
    { text: "  ⟳ page_implement_agent  [home]", delay: 3300, color: "text-primary" },
    { text: "    write app/page.tsx      ✓", delay: 3600, color: "text-green-400/80" },
    { text: "    components/HeroSection  ✓", delay: 3850, color: "text-green-400/80" },
    { text: "    components/ProductGrid  ✓", delay: 4050, color: "text-green-400/80" },
    { text: "  ✓ chrome_optimize_agent  [nav+footer once]", delay: 4400, color: "text-primary" },
    { text: "    app/layout.tsx          ✓", delay: 4550, color: "text-green-400/80" },
    { text: "    components/chrome/Nav   ✓", delay: 4700, color: "text-green-400/80" },
    { text: "  ✓ install_dependencies", delay: 5000, color: "text-primary" },
    { text: "    + framer-motion  + lucide-react", delay: 5300, color: "text-muted-foreground/70" },
    { text: "  ✓ run_build  [passed]", delay: 5800, color: "text-green-400" },
    { text: "", delay: 6100, color: "" },
    { text: "  ● ready  → 预览已就绪", delay: 6300, color: "text-accent-tertiary" },
];
