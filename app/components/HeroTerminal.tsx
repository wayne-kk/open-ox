...
const LINES = [
    ...
    { text: "  ✓ architect_scaffold_agent  [chrome-first]", delay: 3000, color: "text-primary" },
    { text: "    app/layout.tsx + chrome/Nav ✓", delay: 3200, color: "text-green-400/80" },
    { text: "  ⟳ page_implement_agent  [home]", delay: 3500, color: "text-primary" },
    { text: "    write app/page.tsx      ✓", delay: 3800, color: "text-green-400/80" },
    ...
    { text: "  ✓ chrome_optimize_agent  [link polish]", delay: 4600, color: "text-primary" },
    { text: "    Nav/Footer hrefs        ✓", delay: 4800, color: "text-green-400/80" },
