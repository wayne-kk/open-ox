...
const PHASE_ROWS: [string, string, string][] = [
  ...
  ["match_design_system_skill", "steps/matchDesignSystemSkill.md + outputJson", "Top 3 设计系统候选 metadata"],
  ["generate_project_design_system", "DesignSystemResolver / generation fallback", "infer + 可选 styleGuide"],
