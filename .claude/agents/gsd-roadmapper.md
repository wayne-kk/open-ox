...
Reference full template: `/Users/wangwei/coding/open-ox/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/wangwei/coding/open-ox/.claude/get-shit-done/templates/state.md`.
