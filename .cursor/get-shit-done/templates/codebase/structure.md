...
- Usage: Reference from command with `@/Users/wangwei/coding/open-ox/.cursor/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/wangwei/coding/open-ox/.cursor/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/wangwei/coding/open-ox/.cursor/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
