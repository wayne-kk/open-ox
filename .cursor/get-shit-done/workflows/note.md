...
- **Global scope**: `/Users/wangwei/coding/open-ox/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/wangwei/coding/open-ox/.cursor/notes/`)
...
2. Glob `/Users/wangwei/coding/open-ox/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (/Users/wangwei/coding/open-ox/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/wangwei/coding/open-ox/.cursor/notes/` — works in any directory
