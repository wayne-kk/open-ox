...
是否需要图片：不需要图片。超大排版 + 径向光晕已经撑起首屏视觉，加图片反而分散焦点
...
是否需要图片：需要图片。左侧放品牌故事相关的场景图，承担主视觉叙事
...
是否需要图片：不需要图片。卡片内用图标 + 文字即可，网格背景已提供视觉层次
