...
import { Pumpkin, Menu, X, Ghost } from "lucide-react";
...
const NavigationSection = () => {
  ...
  // Custom styles for the gothic neon aesthetic
  ...
  return (
    ...
    >
      {/* Gothic Grid Background Overlay (Subtle) */}
      <div
      ...
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between relative z-10">
        ...
        >
          <div className="relative">
            <Pumpkin className="w-8 h-8 text-[#FF6200] transition-transform duration-500 group-hover:rotate-12 group-hover:scale-110" />
