              ...
              <div className="flex gap-4">
                {[
                  ...
                  <a
                    ...
                    className="p-3 bg-[#16141A] border border-[#3D3945] text-[#F2F2F7] hover:text-[#32FF7E] hover:border-[#32FF7E] transition-all hover:-translate-y-1 shadow-[4px_4px_0px_0px_rgba(50,255,126,0.15)]"
                    style={{
                      clipPath:
