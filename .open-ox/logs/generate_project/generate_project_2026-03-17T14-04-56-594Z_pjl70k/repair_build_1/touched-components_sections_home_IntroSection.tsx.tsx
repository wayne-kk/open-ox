    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#050505] py-24 px-6">
      ...
      <div className="relative z-10 max-w-5xl w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-8 flex flex-col">
          ...
          <h2 className="font-display text-4xl md:text-6xl lg:text-7xl italic text-[#E0E0E0] mb-8 leading-none tracking-tighter">
            THE{" "}
          ...
          <div className="relative p-8 md:p-12 bg-[#0D0D0F] border border-[#2A2A2F] clip-cyber group">
            {/* Top-left accent */}
