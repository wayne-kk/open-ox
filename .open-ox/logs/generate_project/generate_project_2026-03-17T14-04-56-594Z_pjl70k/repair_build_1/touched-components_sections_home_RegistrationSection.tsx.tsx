      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-12 text-center md:text-left">
            <div className="inline-flex items-center gap-2 px-3 py-1 border border-[#00F3FF]/30 bg-[#00F3FF]/5 mb-4">
            ...
            <h2 className="font-header text-4xl md:text-6xl text-[#E0E0E0] uppercase tracking-widest mb-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                {status !== "success" ? (
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        {["Infiltrator", "Netrunner", "Enforcer"].map((cls) => (
                          <button
                            key={cls}
                            type="button"
                            onClick={() =>
                  ...
                  <div className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <p className="font-body text-[#88888F] max-w-xs mb-8">
                      Your neural link has been established. Check your terminal
                      for the entry coordinates.
                    </p>
                    <button
            ...
            <div className="lg:col-span-5 space-y-6">
              <div className="p-6 border border-[#2A2A2F] bg-[#0D0D0F]/50 backdrop-blur-sm">
              ...
              <div className="p-6 border border-[#FF3131]/20 bg-[#FF3131]/5">
