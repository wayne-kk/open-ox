  ...
  return (
    <section className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#050505] py-24 px-6 md:px-12">
      ...
      <div className="relative z-10 max-w-5xl w-full flex flex-col items-center text-center">
        ...
        <div className="mb-8 flex items-center gap-3 px-4 py-1.5 border border-[#BCFF00]/30 bg-[#BCFF00]/5 backdrop-blur-sm">
        ...
        <p className="font-body text-base md:text-xl text-[#88888F] max-w-2xl mb-12 leading-relaxed">
        ...
        {/* Social Proof / Stats */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-3xl border-t border-[#2A2A2F] pt-12">
