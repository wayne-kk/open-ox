...
export default function NavigationSection() {
  ...
  return (
    ...
    >
      ...
      {/* Mobile Menu Overlay */}
      {isOpen && (
        <div className="fixed inset-0 top-[73px] bg-[#050505] z-40 lg:hidden overflow-hidden transition-all duration-300">
            ...
            <div className="flex flex-col gap-8">
              {navLinks.map((link) => (
                <a
                  ...
                  className="font-header text-4xl uppercase tracking-widest text-[#E0E0E0] hover:text-[#FF00FF] border-b border-[#2A2A2F] pb-4 flex justify-between items-center group transition-all"
                >
                  {link.name}
